...
export default function Datenschutz1Section() {
  ...
  const flipCards = [
    { title: "Gefahren bei Nichtbeachtung", description: "Identitätsdiebstahl, Diskriminierung und Vertrauensverlust sind mögliche Folgen." },
    { title: "Datenschutzprinzipien", description: "Datensparsamkeit, Zweckbindung, Transparenz und Verhältnismässigkeit." },
    { title: "Sensibilisierung", description: "Lernende sind regelmässig zu datenschutzrechtlichen Themen zu sensibilisieren." },
  ];
  ...
  return (
    <SectionCard chapterLabel="Kapitel 7" title="Datenschutz – Grundlagen">
      ...
      <RoleHint role="lehrpersonen">
        Sie sind dafür verantwortlich, Lernende regelmässig zu datenschutzrechtlichen Themen zu sensibilisieren.
      </RoleHint>
    </SectionCard>
  );
}
