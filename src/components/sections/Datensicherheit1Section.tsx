...
export default function Datensicherheit1Section() {
  ...
  return (
    <SectionCard chapterLabel="Kapitel 3" title="Datensicherheit – Grundlagen">
      <p className="text-gray-700 leading-relaxed">
        <InfoTerm>Datensicherheit</InfoTerm> und{" "}
        <InfoTerm>Datenschutz</InfoTerm> sind zentrale Themen der NRL.
        Schützen Sie Ihre Zugänge mit <InfoTerm>MFA</InfoTerm>.
        Die BBW verfügt über eine eigene <InfoTerm>Firewall</InfoTerm>, die
        das Schulnetz absichert.
      </p>
